...
public class ParasiteItem {
	...
	public List<Recipe> getRecipe(){
		...
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", "   " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.MAGMA_CREAM));//岩浆膏
		im.setDisplayName(ParasiteData.getItemCureName()+ParasiteData.ParasiteName[1]);
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", "   " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.GHAST_TEAR));//恶魂之泪
		im.setDisplayName(ParasiteData.getItemCureName()+ParasiteData.ParasiteName[2]);
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", "   " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.FERMENTED_SPIDER_EYE));//发酵蜘蛛眼
		im.setDisplayName(ParasiteData.getItemCureName()+ParasiteData.ParasiteName[3]);
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", " Z " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.SUGAR).setIngredient('Z',Material.EGG));//糖,鸡蛋
		im.setDisplayName(ParasiteData.getItemCureName()+ParasiteData.ParasiteName[4]);
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", " Z " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.SUGAR).setIngredient('Z',Material.MELON));//糖,西瓜
		im.setDisplayName(ParasiteData.getItemCureName()+ParasiteData.ParasiteName[5]);
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", "   " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.GOLDEN_CARROT));//金胡萝卜
		im.setLore(ParasiteData.getItemNoLore());
		im.setDisplayName(ParasiteData.getItemNoName());
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", "   " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(2))).setIngredient('Y',Material.ICE));//冰
		is.setType(Material.GLOWSTONE_DUST);
		im.setDisplayName(ParasiteData.getItemBtName());
		im.setLore(ParasiteData.getItemBtLore());
		is.setItemMeta(im);
		re.add(new ShapedRecipe(is).shape(new String[] { " Y ", " X ", "   " }).setIngredient('X',Material.getMaterial(ParasiteData.fuckBukkit(3))).setIngredient('Y',Material.SUGAR));//小麦种子，糖
		return re;
	}
